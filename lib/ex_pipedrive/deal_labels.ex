defmodule ExPipedrive.DealLabels do
  @moduledoc """
  ...
  are option values on the `label_ids` field returned by `GET
  /api/v2/dealFields`. This module wraps the API v2 bulk field-options
  endpoints (`POST` / `PATCH` / `DELETE
  /api/v2/dealFields/label_ids/options`) so label definitions can be listed
  ...
  @field_path "dealFields/:field_code"
  @options_path "dealFields/:field_code/options"
