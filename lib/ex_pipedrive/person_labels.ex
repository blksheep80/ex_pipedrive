defmodule ExPipedrive.PersonLabels do
  @moduledoc """
  ...
  labels are option values on the `label_ids` field returned by `GET
  /api/v2/personFields`. This module wraps the API v2 bulk field-options
  endpoints (`POST` / `PATCH` / `DELETE
  /api/v2/personFields/label_ids/options`) so label definitions can be
  ...
  @field_path "personFields/:field_code"
  @options_path "personFields/:field_code/options"
